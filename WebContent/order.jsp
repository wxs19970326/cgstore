...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form id="orderForm" action="${pageContext.request.contextPath}/order?method=pay&oid=${bean.oid}" method="post" class="form-horizontal"
				style="margin-top: 5px; margin-left: 150px;">
				<div class="form-group">
					<label for="username" class="col-sm-1 control-label">地址</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="address"
							name="address" placeholder="请输入收货地址" required="required">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" name="name" class="form-control" id="name"
							placeholder="请输收货人" required="required">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" name="telephone" class="form-control" id="telephone"
							placeholder="请输入联系方式" required="required">
					</div>
				</div>
